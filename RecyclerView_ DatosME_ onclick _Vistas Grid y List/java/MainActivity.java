...
public class MainActivity extends AppCompatActivity {
    ...
    private void construirRecycler() {
        listaPersonajes=new ArrayList<>();  // Lista de Datos
        recyclerPersonajes= (RecyclerView) findViewById(R.id.RecyclerId); // El recycler

        if (Utilidades.visualizacion==Utilidades.LIST){
            recyclerPersonajes.setLayoutManager(new LinearLayoutManager(this));
            // Dependiendo el click, cambia la visualizacion
        }else {
        ...
        // Trae todos los personajes Ya adpatados a la vista que se creo
        ...
        // Esos datos ya adaptados los pone en el ReciclerView
    }
}